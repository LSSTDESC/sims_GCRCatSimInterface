...
def make_r_coor(nc,dsx):
    ...
    ----------
    nc: int
        number of pixels per side for   
    dsx: float
        pixel scale, arcseconds per pixel

    Returns
    ---------- 
    x1: array of horizontal coordinates
    x2: array of vertical coordinates """
...
def alphas_sie(x0, y0, theta, ql, re, le, ext_shears, ext_angle, ext_kappa, x, y):   
    ...
    ----------
    x0: float
        x position of the lens
    y0: float
        y position of the lens
    theta: float
    ...
    x: float
        array x position, generated by make_r_coors
    y: float
        array y-position, generated by make_c_coors

    Returns
    ---------- 
    ai1, ai2: lensed positions in x and y for the two lensing programs, generate_lensed_hosts_***.py """
...
"""Parameters
   ...
   y: float
    original y-position
   xcen: float
    x-position to rotate around
   ycen: float
    y-position to rotate around
   phi: float
    rotation angle in degrees

   Returns
   ----------  
   xnew: rotated x-position
   ynew: rotated y-position      """
...
def sersic_2d(xi1,xi2,xc1,xc2,Reff_arc,ql,pha,ndex):
    ...
    ----------
    xi1:float
        horizontal position for Sersic profile
    xi2:float
        vertical position for Sersic profile
    xc1:float
        horizontal position of source 
    xc2: float
        vertical position of source
    Reff_arc: float
    ...
    Returns
    ----------
    res: magnitude predicted by Sersic profile               """
#--------------------------------------------------------------------
