...
from lsst.sims.catalogs.definitions import parallelCatalogWriter, CompoundInstanceCatalog
from lsst.sims.catalogs.decorators import cached
from lsst.sims.catUtils.baseCatalogModels import StarObj, GalaxyAgnObj, GalaxyDiskObj, GalaxyBulgeObj, SNDBObj
...
class TwinklesCatalogWriter(object):
    """
...
def make_twinkles_cat_header(star_db, obs_md, outfile, object_catalogs=(),
...
def get_twinkles_obs_md(obs_gen, obsHistID, fov=2, dither=True):
    """
...
class TwinklesMaskedPhoSimCatalogPoint(PhoSimCatalogPoint):
    ...
    def column_by_name(self, colname):
        ...
        return super(TwinklesMaskedPhoSimCatalogPoint, self).column_by_name(colname)


class TwinklesBrightStarCatalog(PhoSimCatalogPoint):
    min_mag = None
...
class TwinklesPhoSimDESCQA_ICRS(PhoSimDESCQA):
    catalog_type = 'twinkles_phoSim_catalog_DESCQA_ICRS'
...
class TwinklesMaskedPhoSimCatalogPoint_ICRS(TwinklesMaskedPhoSimCatalogPoint):
    catalog_type = 'twinkles_masked_phoSim_catalog_point_ICRS'
...
class TwinklesBrightStarCatalog_ICRS(TwinklesBrightStarCatalog):
    catalog_type = 'twinkles_bright_star_catalog_point_ICRS'
