...
def load_in_data_agn():
    ...
    """
    agn_host_bulge = pd.read_csv(os.path.join(data_dir,'cosmoDC2_v1.1.4_bulge_agn_host.csv'))
    agn_host_disk = pd.read_csv(os.path.join(data_dir, 'cosmoDC2_v1.1.4_bulge_agn_host.csv'))
