...
the_output = '/global/cscratch1/sd/jrbogart/truth/summary_table_magcut_hp{}_n{}.sqlite3'
...
bad_gals = [cosmoDC2_data['galaxy_id'][()][i] for i in bad_ixes]
    ...
    for i_bp, bp in enumerate('ugrizy'):
        ...
        for component in ['disk', 'bulge']:
            ...
            for i_gal, (s_dex, mn, av,
                ...
                # If not galaxy_ids[i_gal] in valid:   continue
                # There still is a space for it in the arrays, but values
